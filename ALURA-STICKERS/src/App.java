...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // pegar os dados do imdb, com uma conexão HTTP, fazer um get, e guardar todas
        // as informações dentro de uma string.
        ...
        List<Map<String, String>> listaDeFilmes = Parser.parse(body); // colocar = body ele vai rejeitar, pq uma string
                                                                      // é um texto, n é uma lista de filmes. por isso
                                                                      // vai precisar do parse.
        System.out.println();
        System.out.println("Quantos filmes temos? " + listaDeFilmes.size() + " filmes");
        System.out.println(
                "--------------------------------------------------------------------------------------------------------------------------------------------");
        // System.out.println(listaDeFilmes.get(0));// map utilizando chave e
        // demonstrando chave valor,chave valor.
        ...
        for (Map<String, String> filme : listaDeFilmes) { // n existe foreach no java isso é só um template.
            ...
            // System.out.println(filme.get("image")); // list vem na ordem, o map as vezes
            // muda.
